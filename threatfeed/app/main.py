...
from .normalize import NormalizeError, flatten, parse_payload
...
async def ingest(request: Request, payload=Body(...), actor: str = Depends(security.require_ingest)):
    """Terima push indikator dari FortiSOAR. Mendukung rich object maupun array string."""
    ...
    try:
        ...
        raise HTTPException(status.HTTP_400_BAD_REQUEST, f"Payload tidak dikenali: {exc}")
